...
UPLOAD_FOLDER = 'C:\\Users\\risha\\OneDrive\\Desktop\\test\\uploads'  # Change this to the directory where you want to store uploaded files
...
def upload_file():
    ...
    if file and allowed_file(file.filename):
        ...
        return render_template('charts_page.html', charts=charts)
